		...
		<div class="container-fluid sm-padding-10">
			<div class="card card-default">
				...
				<div class="card-body m-t-10">
					<form action="{{ route('backend.user.update', $users->id) }}" method="post" enctype="multipart/form-data">
						@csrf
						@method('PATCH')
						<div class="row">
							<div class="col-md-6">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group form-group-default">
									...
									<input type="password" name="password" placeholder="Minimum of 6 Charactors" class="form-control" autocomplete="new-password">
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6">
								<div class="form-group form-group-default">
									...
									<input type="password" name="repassword" placeholder="Minimum of 6 Charactors" class="form-control" autocomplete="new-password">
								</div>
							</div>
						</div>
